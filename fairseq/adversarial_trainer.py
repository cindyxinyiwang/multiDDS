...
class AdversarialTrainer(Trainer):
    ...
    def __init__(self, args, task, model, criterion, adversarial_criterion, adversary):
        ...
        #self._criterion = criterion.cuda() if criterion is not None else None
    ...
    def train_step(self, samples, update_params=True, augment_adv=True, update_actor=False):
        ...
        agg_logging_output = super(AdversarialTrainer, self).train_step(
            new_samples, update_actor=False,
        )
