...
def save_state(
    ...
    extra_data_actor_state_dict=None, extra_data_optimizer_state_dict=None, bt_data_optimizer_state_dict=None,
):
    ...
    state_dict = {
        ...
        'bt_data_optimizer': bt_data_optimizer_state_dict if bt_data_optimizer_state_dict else {},
    }
