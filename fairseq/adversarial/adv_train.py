...
def get_parser_with_args():
    parser = options.get_parser("Trainer", default_task="pytorch_translate_adversarial")
...
def validate(args, trainer, task, subset, extra_state):
    ...
    if (
        ...
        print(
            ...
            f"validation loss of {extra_state['validate']['lowest_loss']} "
            f"(current loss: {val_loss}) "
