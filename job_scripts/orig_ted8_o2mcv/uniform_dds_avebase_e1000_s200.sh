...
MODEL_DIR=checkpoints/orig_ted8_o2mcv/uniform_dds_avebase_e1000_s200/
mkdir -p $MODEL_DIR
...
#CUDA_VISIBLE_DEVICES=$1 python train.py data-bin/ted_8/ \
python train.py data-bin/ted_8/ \
