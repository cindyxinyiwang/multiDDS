...
MODEL_DIR=checkpoints/bt_iwslt_deen70k/deen_dds_s5_m_dis0.95_lr1e-9_1to10_dbase/
mkdir -p $MODEL_DIR
...
CUDA_VISIBLE_DEVICES=$1 python train.py data-bin/bt_iwslt_deen70k/ \
    ...
    --bt_dds --discount_baseline_size 200  --discount-reward 0.95 \
    --lambda-denoising-config '0:1,10000:10' \
    --reward-scale 1 \
    --data-actor-lr 1e-9 \
